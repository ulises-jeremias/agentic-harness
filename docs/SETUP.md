...
Auto-generated by `bin/devcompanion` whenever you queue a job or run
`devcompanion projects`. **Do not edit manually** — manage it via
`bin/project-indexer` commands instead.
...
- `projects.yaml` — auto-generated project index (managed by `bin/devcompanion`)
...
├── README.md
├── projects.yaml          ← Auto-generated by bin/devcompanion (gitignored)
├── bin/
