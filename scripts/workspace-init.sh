...
dim "  projects.yaml is auto-generated by agent-toolkit devcompanion — no action needed"
dim "  Use bin/project-indexer to clone repos and create project symlinks"
echo ""
