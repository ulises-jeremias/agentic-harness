...
dim "  projects.yaml is auto-generated by bin/devcompanion — no action needed"
dim "  Use agent-toolkit project to clone repos and create project symlinks"
echo ""
...
dim "       agent-toolkit project clone owner/my-project"
echo ""
echo "  3. Open in your AI tool:"
dim "       opencode   # or: claude / cursor / gemini"
echo ""
echo "  4. (Optional) Queue a background job:"
dim "       agent-toolkit devcompanion queue my-project --template code-review"
echo ""
